...
export const UNITS: UnitDef[] = [
  ...
  { label: "EL", aliases: ["el", "esslöffel", "essloeffel", "tbsp", "tbsp.", "tablespoon", "tablespoons"] },
  { label: "TL", aliases: ["tl", "teelöffel", "teeloeffel", "tsp", "tsp.", "teaspoon", "teaspoons"] },
  ...
  { label: "Blatt", aliases: ["blatt", "blätter", "blaetter", "leaf", "leaves"] },
